...
public class MmsConfig {
	...
	private static boolean mStrictComparePhoneNumber = false;
	...
	// longer
	// than a single segment (i.e. 140 chars), then the message will turn into
	// and be sent
	...
	private static boolean mEnableMMSReadReports = true; // key:
															// "enableMMSReadReports"
	private static boolean mEnableSMSDeliveryReports = true; // key:
																// "enableSMSDeliveryReports"
	private static boolean mEnableMMSDeliveryReports = true; // key:
	...
	private static int mMaxSubjectLength = 40; // maximum number of characters
												// allowed for mms
												// subject

	// If mEnableGroupMms is true, a message with multiple recipients,
	// regardless of contents,
	// will be sent as a single MMS message with multiple "TO" fields set for
	// each recipient.
	// If mEnableGroupMms is false, the group MMS setting/preference will be
	...
	public static boolean getStrictComparePhoneNumber() {
		return mStrictComparePhoneNumber;
	}
