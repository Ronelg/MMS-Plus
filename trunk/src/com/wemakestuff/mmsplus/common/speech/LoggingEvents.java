package com.wemakestuff.mmsplus.common.speech;

/**
 * Logging event constants used for Voice Search and VoiceIME. These are the
 * keys and values of extras to be specified in logging broadcast intents. This
 * class is used by clients of the android.speech APIs to log how the user
 * interacts with the IME settings and speech recognition result.
 */
public class LoggingEvents {
	...
	// The extra key used to log the time in milliseconds at which the
	// EXTRA_EVENT
	...
	public class VoiceSearch {
		...
		public static final String EXTRA_N_BEST_CHOOSE_INDEX = "index"; // value
																		// should
																		// be
																		// int

		public static final int QUERY_UPDATED = 3;
		public static final String EXTRA_QUERY_UPDATED_VALUE = "value"; // value
																		// should
																		// be
																		// String
	...
	public class VoiceIme {
		...
		public static final String EXTRA_ERROR_CODE = "code"; // value should be
																// int

		public static final int START = 14;
		public static final String EXTRA_START_LOCALE = "locale"; // value
																	// should be
																	// String
		public static final String EXTRA_START_SWIPE = "swipe"; // value should
																// be boolean
		// EXTRA_START_SWIPE is deprecated; switch to EXTRA_START_METHOD instead
		public static final String EXTRA_START_METHOD = "method"; // value
																	// should be
																	// int below
		...
		public static final String EXTRA_TEXT_MODIFIED_LENGTH = "length"; // value
																			// should
																			// be
																			// int
		public static final String EXTRA_TEXT_REPLACED_LENGTH = "rlength"; // value
																			// should
																			// be
																			// int
		public static final String EXTRA_TEXT_MODIFIED_TYPE = "type"; // value
																		// should
																		// be
																		// int
																		// below
